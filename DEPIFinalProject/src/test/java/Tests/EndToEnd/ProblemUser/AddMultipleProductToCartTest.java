...
public class AddMultipleProductToCartTest extends TestBase {

    // Login as problem user ==> add product 1 ==> add product 2 ==> check if products appears in cart.
    ...
    public void addProduct1() {
        ...
        product1Title = driver.findElement(By.xpath("//*[@id=\"item_4_title_link\"]/div")).getText();
    ...
    public void addProduct2() {
        ...
        product2Title = driver.findElement(By.xpath("//*[@id=\"item_1_title_link\"]/div")).getText();
