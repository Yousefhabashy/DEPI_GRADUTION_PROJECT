...
public class CancelPurchaseAndCheckCartTest extends TestBase {

    // Login as standard user ==> add product to cart ==> check if product appears in cart ==> checkout product and cancel at step 2  ==> check product still at cart.
